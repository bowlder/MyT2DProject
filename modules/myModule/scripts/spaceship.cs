function createSpaceShip()
{
	...
	// It will run a function called onCollision.
	%spaceship.setCollisionCallback( true );
	
	// Add the sprite to the scene.
	myScene.add( %spaceship );
	
	// SetFixedAngle prevents the spaceship`s rotation from being influenced by Collision and physics forces
...
function PlayerShip::accelerate(%this)
{
	...
	else
	{
		...
		// We temporarily increase the Damping of Angular velocity so that the ship turns slower when at full thrusting
